...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    static {
        ...
        //DiskFileUpload.baseDirectory = "/Users/lingzhang/Desktop/"; // system temp directory
            ...
            if (data.getHttpDataType() == HttpDataType.FileUpload) {
                ...
                if (fileUpload.isCompleted()) {
                    ...
                    if (fileUpload.length() < 100000) {
                     ...
                     //File dest = new File("/Users/lingzhang/Desktop/test.txt");
                     File dest = new File("/Users/lingzhang/Desktop/test.jpeg");
                   //File dest = new File("/Users/lingzhang/Desktop/test.json");
	                    if (!dest.exists()) {
	                    	 try {
								dest.createNewFile();
							} catch (IOException e) {
