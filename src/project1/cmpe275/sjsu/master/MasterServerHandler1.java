...
/**
 * Handler1 : handle msg contain uri like: xxx.xxx.xx.xx : 8080/
 *
 */
public class MasterServerHandler1 extends SimpleChannelInboundHandler<HttpObject>{
	
	private static final Logger logger = Logger.getLogger(MasterServerHandler1.class.getName());
